...
public class UserDetailsServletTest {
	 @Mock
		...
		@Test
	    public void userDetailsServlet_testDoPost_success() throws ServletException, IOException, UserDetailsNotFoundException  {
		...
		/* when(response.getWriter()).thenReturn(pw); */
	        ...
	        verify(userDetailsServlet,times(1)).doPost(request, response);
		/*
